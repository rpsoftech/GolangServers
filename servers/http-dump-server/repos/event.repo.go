...
func init() {
	...
	mongodb.AddIndexesToCollection([]string{"key", "occurredAt", "eventName", "parentNames"}, EventRepo.collection)
}

func (repo *EventRepoStruct) Save(entity *dump_server_events.DumpServerBaseEvent) error {
